  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 grid gap-4 sm:grid-cols-2">
      ...
      <button
        ...
        className="relative sm:col-span-2 w-fit overflow-hidden rounded-full bg-coral px-6 py-3 font-body font-medium text-white transition-all duration-200 hover:scale-105 hover:bg-coral/90 hover:shadow-lg active:scale-95 disabled:opacity-60 disabled:hover:scale-100"
      >
